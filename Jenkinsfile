node() {
   ...
   docker.withRegistry("https:registry.hub.docker.com", "docker-hub"){
            ...
            stage('Push Docker Images'){
               withCredentials([usernamePassword(credentialsId: 'rangandocker', passwordVariable: 'Rondocker@86', usernameVariable: 'rangandocker')]) {
                     sh "docker login -u 'rangandocker' -p 'Rondocker@86' ${props.registry}"
